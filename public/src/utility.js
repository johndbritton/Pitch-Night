var pitchNight = {
	...
	getListUrl: [this.baseUrl+"activities",this.baseUrl+"users",this.baseUrl+"pitches","",this.baseUrl+"pitches",""],
				...
				switch(rootObject){
					...
					case 'user':
						$(feed).find("user").each(function(){
							...
							elem.append("<ul class=\"edgetoedge\"><li><img src=\""+imgUrl+"\" alt=\""+username+"\"/></li><li>"+username+"</li><li><a href=\""+pitchNight.handleUrls[0]+""+handle+"\"><img src=\"../images/twitter.png\" /></a></li></ul>");
						});
						break;
					case 'pitch':var count = 1;
						$(feed).find("pitch").each(function(){
							...
							elem.append("<ul class=\"edgetoedge\"><li><img src=\""+imgUrl+"\" alt=\""+username+"\"/></li><li>"+title+"</li><li>/*<a href=\""+pitchNight.handleUrls[0]+""+handle+"\"><img src=\"../images/twitter.png\" /></a>*/</li></ul>");
							count += 1;
						});
						break;
				};
